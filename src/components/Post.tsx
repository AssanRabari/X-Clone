...
import PostIneractions from "./PostIneractions";
        ...
        <div className="flex-1 flex flex-col gap-2">
          <div className="flex justify-between w-full">
            <Link href={`/test`} className="flex gap-4">
              ...
              >
                ...
                {type !== "status" && (
                  <span className="text-textGray">1 week ago</span>
                )}
              </div>
            </Link>
            <PostInfo />
          ...
          <Link href={`/test/status/123`}>
            <p className={`${type === "status" && "text-lg"}`}>
              ...
              perspiciatis eos aliquam, magnam minus, sint cum hic expedita, est
              omnis officiis accusamus corporis commodi nobis quisquam explicabo
